<?php
    ...
    ////////////////// Cambio de funcion
    $table_data -> get2('script_movil_ob','session_id', array('nombre_agente','rut_usuario','fecha_hora_ingreso','pcs', 'session_id','tipo', 'campana_t', 'producto','rut_cliente',
    'tipo_cliente', 'dni_cliente', 'nombre_cliente','fecha_ingreso', 'hora_ingreso', 'empresa', 'apellido_cliente',
    'f_activacion', 'edad', 'sexo', 'email', 'direccion', 'accion', 'cantidad', 'forma_entrega',
