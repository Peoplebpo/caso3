    ...
    columnDefs: [
      {
        targets: -1,
        defaultContent:
          "<div class='wrapper text-center'><button type='button' class='btn btn-primary btnMostrar' data-bs-toggle='modal' data-bs-target='#modalCRUD' data-toggle='tooltip' title='Ver'><i class='fas fa-eye'></i></button></div>",
      },
    ],
