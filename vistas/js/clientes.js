$(document).ready(function () {
    ...
    columnDefs: [
      {
        targets: -1,
        defaultContent:
          "<div class='wrapper text-center'><div class='btn-group'><button class='btn btn-info btn-sm btnEditar' data-toggle='tooltip' title='Editar'><i class='fas fa-user-edit'></i></button><button style='margin-left:5px' class='btn btn-danger btn-sm btnBorrar' data-toggle='tooltip' title='Eliminar'><i class='fas fa-user-minus'></i></button></div></div>",
      },
    ],
  ...
  $("#btnguardar").click(function () {
    ...
    $("#modalclientes .modal-title").text("Agregar Clientes");  
  });
  ...
  $(document).on("click", ".btnEditar", function () {
    ...
    $("#modalclientes").modal("show");
    $("#modalclientes .modal-title").text("Editar Cliente");   
  });
