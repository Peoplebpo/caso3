$(document).ready(function() {
   ...
   tablaProductos = $('#tablaProductos').DataTable({    
           ...
           "bDeferRender": true,	
           "bServerSide": true,                
           "sAjaxSource": "modelos/serverside/tipo_venta.php",	
           "columnDefs": [ {
               "targets": -1,        
   ...
   $('#formproductos').submit(function(e){                         
       ...
       nombre = $.trim($('#nombre').val());   
           ...
           $.ajax({
             url: "modelos/include/tipo_venta.php",
             type: "POST",
             datatype:"json",    
   ...
   $("#btnguardar").click(function(){
       ...
       $(".modal-title").text("Alta Tipo Venta");
   ...
   $(document).on("click", ".btnEditar", function(){		        
       ...
       $(".modal-header").css("color", "white" );
       $(".modal-title").text("Editar Tipo Venta");		
       $('#modalCRUD').modal('show');		 
   ...
   $(document).on("click", ".btnBorrar", function(){
       ...
       opcion = 3; //eliminar  
       Swal.fire({
         title: '¿Desea eliminar este Tipo Venta?',
            ...
            $.ajax({
              ...
              success: function() {
               Swal.fire({
                  position: 'top',
                  icon: 'success',
                  title: 'Tipo Venta eliminado con exito'
                })
