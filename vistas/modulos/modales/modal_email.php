...
<body>
  ...
  <!-- Modal -->
  <div class="modal fade" id="subir_email" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg ">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <iframe src="modelos/reportes/agg_emailc.php" height="500" width="770px" scrolling="no" frameborder="0"></iframe>
