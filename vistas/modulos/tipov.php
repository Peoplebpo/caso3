...
<script type="text/javascript" src="vistas/js/tipo_venta.js"></script>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tipo Venta</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                           ...
                           <div class="container-fluid my-3">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col d-grid gap-2 d-md-flex justify-content-md-end">
                                      ...
                                      <button id="btnguardar" type="button" class="btn btn-info text-white"  data-bs-toggle="modal">Agregar Tipo Venta</button>
