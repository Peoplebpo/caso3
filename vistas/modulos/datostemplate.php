<script type="text/javascript" src="vistas/js/template.js"></script>
          ...
          <div class="card">
            ...
            <div class="container-fluid my-2">
              ...
              <div class="row">
                       ...
                       <div class="row">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control my-2"  name="contenido" id="contenido" style="height: 100px"disabled></textarea>
                          </div>
                        </div>
                ...
                <button type="submit" class="btn_ingresar btn btn-primary w-100 my-3" id="btn_update">Actualizar Plantilla</button>
